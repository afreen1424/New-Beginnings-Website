...
export default function BlogDetailPage() {
  ...
  if (!post) {
    return (
      <div className="bg-[#E8D8C3] px-5 pb-20 pt-28 text-center" data-testid="blog-not-found-page">
        <h1 className="serif-display text-4xl text-[#3E0B14]" data-testid="blog-not-found-heading">
          Story Not Found
        </h1>
  ...
  return (
    <div className="bg-[#E8D8C3] px-5 pb-20 pt-28 sm:px-8 lg:px-12" data-testid="blog-detail-page">
      <article className="mx-auto w-full max-w-5xl" data-testid="blog-detail-article">
        ...
        <section className="mt-12" data-testid="blog-detail-gallery">
          <h3 className="serif-display text-2xl text-[#3E0B14]" data-testid="blog-detail-gallery-heading">
            Gallery
          </h3>
