...
export default function EventDetailPage() {
  ...
  if (!event) {
    return (
      <div className="bg-[#E8D8C3] px-5 pb-20 pt-28 text-center sm:px-8" data-testid="event-not-found-page">
        <h1 className="serif-display text-4xl text-[#3E0B14]" data-testid="event-not-found-heading">
          Event Not Found
        </h1>
  ...
  return (
    <div className="bg-[#E8D8C3] px-5 pb-20 pt-28 sm:px-8 lg:px-12" data-testid="event-detail-page">
      <div className="mx-auto w-full max-w-6xl">
        ...
        <h1 className="serif-display mt-10 text-4xl text-[#3E0B14] sm:text-5xl" data-testid="event-detail-title">
          {event.title}
        </h1>
        <p className="mt-3 text-sm uppercase tracking-[0.24em] text-[#5A0F1C]" data-testid="event-detail-subtitle">
          {event.subtitle}
        </p>
        ...
        {event.testimonial && (
          <blockquote
            className="mt-8 rounded-2xl border border-[#C6A75E]/40 bg-white p-6 text-base italic text-[#5A0F1C]"
